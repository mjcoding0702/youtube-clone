...
export default function VideoForm() {
    ...
    const [videoKey, setVideoKey] = useState(Math.random());  // Add this line
    const [thumbnailKey, setThumbnailKey] = useState(Math.random());  // Add this line
    ...
    const handleSubmit = async (event) => {
        ...
        const formData = {title,description,videoFile,thumbnailFile,userId}
            ...
            <div className="col-6 col-xl-5">
                ...
                <form className="border border-secondary p-3 rounded" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className={`form-control ${title.length > 100 ? 'border-danger' : ''}`} id="title" value={title} required onChange={handleTitleChange} maxLength="100" />
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className={`form-control ${description.length > 500 ? 'border-danger' : ''}`} id="description" rows="3" value={description} required onChange={handleDescriptionChange} maxLength="500"></textarea>
